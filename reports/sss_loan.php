...
$pdf->addText(290,680,11,'<c:alink:http://rmn-hris.crokodz.com/reports/sss_loan_file.php?file=' . $File . '>' . $File . '</c:alink>');//"developed by R&OS Ltd\n<c:alink:http://www.ros.co.nz/pdf/>http://www.ros.co.nz/pdf</c:alink>"
