...
while ($row = mysql_fetch_array($result,MYSQL_ASSOC)){
	...
	?>
		<tr <?php if ($row['status'] == 'LWOP') { echo 'bgcolor="#4CC552"'; }?> <?php echo $bg; ?>>
			...
			<td><input type="text" name="in<?php echo $x; ?>" id="in<?php echo $x; ?>" value="<?php echo cutz($row['trxn_time_in']); ?>" maxlength="5" style="width:40px;background-color:yellow;border:1px solid #000;" onkeydown="javascript:return maskTime(this,event.keyCode);"></td>
			<td><input type="text" name="out<?php echo $x; ?>" id="out<?php echo $x; ?>" value="<?php echo cutz($row['trxn_time_out']); ?>" maxlength="5" style="width:40px;background-color:yellow;border:1px solid #000;" onkeydown="javascript:return maskTime(this,event.keyCode);"></td>
			<td><?php echo m2h($row['total']); ?></td>
			<td><?php echo m2h($row['late']); ?></td>
			<td><?php echo m2h($row['ut']); ?></td>
			<td><input type="text" name="ot_in<?php echo $x; ?>" id="ot_in<?php echo $x; ?>" value="<?php echo cutz($row['ot_in']); ?>" maxlength="5" style="width:40px;background-color:yellow;border:1px solid #000;"  onkeydown="javascript:return maskTime(this,event.keyCode);"></td>
			<td><input type="text" name="ot_out<?php echo $x; ?>" id="ot_out<?php echo $x; ?>" value="<?php echo cutz($row['ot_out']); ?>" maxlength="5" style="width:40px;background-color:yellow;border:1px solid #000;" onkeydown="javascript:return maskTime(this,event.keyCode);"></td>
			<td><input type="text" name="ot<?php echo $x; ?>" value="<?php echo m2h($row['ot']); ?>" style="width:40px;" maxlength="5" readonly></td>
			<td><input type="text" name="otx<?php echo $x; ?>" value="<?php echo m2h($row['otx']); ?>" style="width:40px;" maxlength="5" readonly></td>
			<td><input type="text" name="nd<?php echo $x; ?>" value="<?php echo m2h($row['nd']); ?>" style="width:40px;" maxlength="5" readonly></td>
