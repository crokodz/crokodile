<?php
if (isset($_POST['madd'])){
	$insert = "insert into employee_merits values (NULL,'" . $_GET['id'] . "','" . $_POST['name'] . "','" . $_POST['description'] . "','" . $_POST['date'] . "')";
	mysql_query($insert, connect());
	}

if (isset($_POST['mdel'])){
	$delete = "delete from employee_merits where id = '" . $_POST['id'] . "'";
...
<table width=100% border="1" cellpadding="4" cellspacing="0" rules="all" bgcolor="#999FFF">
	<tr>
		<td colspan=4 align="left">Merits</td>
	</tr>
	<tr>
	...
	<?php
	$select = "select * from employee_merits  where em_id = '" . $_GET['id'] . "'";
