...
<div style="display:inline-block;">
	<input type="submit" name="upsded" id="upsded" value="upload xml" onclick="return onups('file_name');" disabled>
...
<?php
$select = "select * from cronjob where `username` = '" . $_SESSION['user'] . "' and type = 'ded' and `status` = 2";
$result = mysql_query($select, connect());
$x = 0;
while ($row = mysql_fetch_array($result,MYSQL_ASSOC)){
$style = "";
