<?php
if (isset($_POST['add'])){
	$insert = "insert into employee_language values (NULL,'" . $_GET['id'] . "','" . $_POST['name'] . "','" . $_POST['remarks'] . "')";
	mysql_query($insert, connect());
	}

if (isset($_POST['del'])){
	$delete = "delete from employee_language where id = '" . $_POST['id'] . "'";
...
<table width=100% border="1" cellpadding="4" cellspacing="0" rules="all" bgcolor="gray">
	<tr>
		<td colspan=3 align="left">LANGUAGE</td>
	</tr>
	<tr>
		<td>Title</td>
	...
	<?php
	$select = "select * from employee_language where em_id = '" . $_GET['id'] . "'";
	$result = mysql_query($select, connect());
	while ($row = mysql_fetch_array($result,MYSQL_ASSOC)){
	?>
	<tr>
