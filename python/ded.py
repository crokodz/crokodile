	...
	if em[x][3] > 0:
		...
		while bal >= em[x][3]:
			...
			insert = """ insert into employee_deduction (
					...
					'%s', '%s', 'SSS LOAN', '%s', 'pending', curdate(), 'admin', now(), curdate(), curdate(), '%s', '%s', '%s', '%s'
	...
	if em[x][5] > 0:
		...
		while bal >= em[x][5]:
			...
			insert = """ insert into employee_deduction (
					...
					ded_amount,
					granted_amount) values (
					'%s', '%s', 'CRU LOAN', '%s', 'pending', curdate(), 'admin', now(), curdate(), curdate(), '%s', '%s', '%s', '%s'
	...
	if em[x][7] > 0:
		...
		while bal >= em[x][7]:
			...
			insert = """ insert into employee_deduction (
					...
					ded_amount,
					granted_amount) values (
					'%s', '%s', 'CRU SHARES LOAN', '%s', 'pending', curdate(), 'admin', now(), curdate(), curdate(), '%s', '%s', '%s', '%s'
	...
	if em[x][9] > 0:
		...
		while bal >= em[x][9]:
			...
			insert = """ insert into employee_deduction (
					...
					ded_amount,
					granted_amount) values (
					'%s', '%s', 'PAG-IBIG LOAN', '%s', 'pending', curdate(), 'admin', now(), curdate(), curdate(), '%s', '%s', '%s', '%s'
